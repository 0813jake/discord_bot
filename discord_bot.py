...
async def on_message(message):
    ...
    if message.content == "j!소스코드":
        await message.channel.send("깃허브 --> https://github.com/0813jake/discord_bot")
        
    if message.content == "j!문의":
        await message.channel.send("'0813jake#0638'로 친추 주시면 3일정도 내로 친추 받아서 문의 들어드립니다.")
